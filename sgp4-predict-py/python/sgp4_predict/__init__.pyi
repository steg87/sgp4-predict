...
class Predictor:
    ...
    def observe_at(self, t: datetime, observer: GroundStation) -> Observation: ...
    def prediction_iter(self, interval: IntervalRange, step: timedelta) -> PredictionIter: ...
    def observation_iter(self, observer: GroundStation, interval: IntervalRange, step: timedelta) -> ObservationIter: ...
    def transits_iter(self, observer: GroundStation, interval: IntervalRange, min_elevation_deg: float) -> TransitIter: ...
    def apsis_iter(self, interval: IntervalRange) -> ApsisIter: ...
    def illumination_iter(self, interval: IntervalRange) -> IlluminationIter: ...
    def detect_transit(self, t: datetime, observer: GroundStation, min_elevation_deg: float) -> Transit | None: ...
    def max_elevation(self, observer: GroundStation, interval: IntervalRange) -> tuple[datetime, Observation]: ...
